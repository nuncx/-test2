"""
Main window for RSPS Color Bot v3 - CLEANED VERSION

Removed unused features:
- Teleport panel (not integrated)
- Potion panel (not integrated)
- Instance panel (not integrated)
"""
import logging
...
class MainWindow(QMainWindow):
    ...
    CLEANED VERSION - Removed non-functional features:
    - Teleport Settings (not integrated with bot loop)
    - Potion Settings (not integrated with bot loop)
    - Instance Settings (not integrated with bot loop)
    """
    ...
    def __init__(self, config_manager, bot_controller):
        ...
        logger.info("Main window initialized (cleaned version)")
    ...
    def init_tabs(self):
        ...
        CLEANED: Only functional tabs included
        """
        # Main control tab
        ...
        logger.info("Initialized 6 functional tabs (removed 3 non-functional tabs)")
